...
from local_ocpa.ocpa.objects.log.importer.ocel.parameters import JsonParseParameters
from local_ocpa.ocpa.objects.log.variants.obj import Event, Obj, ObjectCentricEventLog, MetaObjectCentricData, RawObjectCentricData
from local_ocpa.ocpa.objects.log.ocel import OCEL
import local_ocpa.ocpa.objects.log.converter.factory as convert_factory
from local_ocpa.ocpa.objects.log.variants.table import Table
from local_ocpa.ocpa.objects.log.variants.graph import EventGraph
import local_ocpa.ocpa.objects.log.variants.util.table as table_utils
