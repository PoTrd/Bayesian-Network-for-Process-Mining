...
from local_ocpa.ocpa.objects.log.importer.ocel.versions import import_ocel_json
from local_ocpa.ocpa.objects.log.importer.ocel.versions import import_ocel_xml
