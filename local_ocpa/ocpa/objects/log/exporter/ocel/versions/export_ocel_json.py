...
import pickle
from local_ocpa.ocpa.objects.log.variants.obj import Event, Obj, ObjectCentricEventLog
from local_ocpa.ocpa.objects.log.util.param import JsonParseParameters
import json
